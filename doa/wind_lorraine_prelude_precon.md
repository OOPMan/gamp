...
If this is the Automa's first turn, and it is Materializing its first Champion, place the Champion in the **right-most** 
position in the Field, otherwise place the Materialized Card it to the immediate **left** of the Automa's Champion (unless
it is a Champion in which case you should place it stacked with the current Champion), shifting any cards in the Field 
to the **left** in order to do so.
...
2. If the Automa...
   1. ...*is not capable* of paying the Reserve Cost for the Revealed Card *OR* there are *no valid [Targets](#targeting)* 
      for the Revealed Card, place it in [Automa Hand Graveyard](#the-automa-hand-graveyard) and draw a new Card from the 
      Main Deck to the [Automa Hand](#the-automa-hand) in the position that the Revealed Card resided in before being 
      Revealed. This newly drawn Card is considered to be part of the [Automa Hand](#the-automa-hand) for the purposes 
      of paying Reserve Costs but *can not be evaluated for Activation*. It is drawn simply to ensure that failed 
      Activations do not result in the size of the [Automa Hand](#the-automa-hand) changing
   2. ...*is capable* of paying the Reserve Cost for the revealed Card using the remaining Cards in the [Automa Hand](#the-automa-hand) 
      ...
      pay a Reserve Cost, start with the **left-most face-down** card in the [Automa Hand](#the-automa-hand) and proceed 
      right across the [Automa Hand](#the-automa-hand) until the Reserve Cost has been paid. If the Revealed Card is an
      Ally place it in the **left-most** position in the Field, shifting any cards in the Field to the **right** in order
      to do so, if necessary.
3. Repeat this process with the next **left-most** card in the [Automa Hand](#the-automa-hand) that was not placed as a
   result of evaluating Step 2.1 of this process. If cards were drawn to the hand as a result of Activation in Step 2.2 
...
#### Attack with Allies
Starting with the **left-most** Ally in the Automa's Field, each Ally that is capable doing so Attacks the Human 
Player's Champion. Remember, Allies with [Intercept](#intercept) will not Attack if the Human Player has any Allies in 
the Field.

### End Phase
The End Phase proceeds as normal for the Automa.
...
### Material Deck
#### Champions
* 1 x [Spirit of Wind](https://index.gatcg.com/card/spirit-of-wind)
* 1 x [Lorraine, Wandering Warrior](https://index.gatcg.com/card/lorraine-wandering-warrior)
* 1 x [Lorraine, Blademaster](https://index.gatcg.com/card/lorraine-blademaster)
* 1 x [Lorraine, Crux Knight](https://index.gatcg.com/card/lorraine-crux-knight)
#### Regalia
* 1 x [Clarent, Sword of Peace](https://index.gatcg.com/card/clarent-sword-of-peace)
* 1 x [Fire Resonance Bauble](https://index.gatcg.com/card/fire-resonance-bauble)
* 1 x [Life Essence Amulet](https://index.gatcg.com/card/life-essence-amulet)
* 1 x [Ornamental Greatsword](https://index.gatcg.com/card/ornamental-greatsword)
* 1 x [Seer's Sword](https://index.gatcg.com/card/seers-sword)
* 1 x [Sword of Seeking](https://index.gatcg.com/card/sword-of-seeking)
* 1 x [Warrior's Longsword](https://index.gatcg.com/card/warriors-longsword)
* 1 x [Prismatic Edge](https://index.gatcg.com/card/prismatic-edge)
### Main Deck
#### Allies
* 3 x [Banner Knight](https://index.gatcg.com/card/banner-knight)
* 4 x [Crusader of Aesa](https://index.gatcg.com/card/crusader-of-aesa)
* 2 x [Dungeon Guide](https://index.gatcg.com/card/dungeon-guide)
* 4 x [Esteemed Knight](https://index.gatcg.com/card/esteemed-knight)
* 4 x [Honorable Vanguard](https://index.gatcg.com/card/honorable-vanguard)
* 4 x [Weaponsmith](https://index.gatcg.com/card/weaponsmith)
* 3 x [Dream Fairy](https://index.gatcg.com/card/dream-fairy)
#### Actions
* 2 x [Inspiring Call](https://index.gatcg.com/card/inpsiring-call)
* 4 x [Scry the Skies](https://index.gatcg.com/card/scry-the-skies)
* 2 x [Disorienting Winds](https://index.gatcg.com/card/disorienting-winds)
* 3 x [Favorable Winds](https://index.gatcg.com/card/favorable-winds)
* 3 x [Crux Sight](https://index.gatcg.com/card/crux-sight)
* 2 x [Spirit Blade: Ascension](https://index.gatcg.com/card/spirit-blade-ascension)
* 1 x [Spirit Blade: Dispersion](https://index.gatcg.com/card/spirit-blade-dispersion)
* 2 x [Spirit Blade: Infusion](https://index.gatcg.com/card/spirit-blade-infusion)
* 3 x [Spirit's Blessing](https://index.gatcg.com/card/spirits-blessing)
#### Attacks
* 3 x [Savage Slash](https://index.gatcg.com/card/savage-slash)
* 2 x [Sudden Steel](https://index.gatcg.com/card/sudden-steel)
